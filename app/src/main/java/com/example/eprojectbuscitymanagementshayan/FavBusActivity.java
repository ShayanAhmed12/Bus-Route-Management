...
public class FavBusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_bus);
        ...
        displayBusData();
        CustomBusWRouteAdapter busadapter = new CustomBusWRouteAdapter(this,busList);
    ...
    void displayBusData()
    {
        ...
        Cursor cursor = DB.getFavBuses(userdb.getUserID());
    ...
    public boolean onContextItemSelected(MenuItem item)
    {
        ...
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(FavBusActivity.this);
            ...
            builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    busList.clear();
                    displayBusData();
                    CustomBusWRouteAdapter busAdapter = new CustomBusWRouteAdapter(FavBusActivity.this,busList);
                    busesListView.setAdapter(busAdapter);
                    busAdapter.notifyDataSetChanged();
        ...
        if(item.getItemId() == R.id.contextMenuBusEdit)
        {
            ...
            Intent intent = new Intent(FavBusActivity.this, EditBusActivity.class);
